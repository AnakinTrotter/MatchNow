...
class MatchProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Hide logout and edit buttons, add match button
        binding.logoutButton.visibility = View.GONE
        binding.editProfileButton.visibility = View.GONE

        val matchButton = View.inflate(context, R.layout.match_button, null)
        binding.root.findViewById<ViewGroup>(R.id.photosContainer).addView(matchButton)

        val matchBtn = matchButton.findViewById<View>(R.id.matchButton)
        matchBtn.setOnClickListener { performMatch() }
